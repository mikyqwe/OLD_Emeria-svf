...
dofile("locale/germany/quest/lib/tables.lua")
dofile(get_locale_base_path().."/quest/Elendosfiles_Dungeons/ChamberWisdomLIB.lua");
dofile(get_locale_base_path().."/quest/Elendosfiles_Dungeons/SharkDungeonLIB.lua");
dofile(get_locale_base_path().."/quest/Elendosfiles_Dungeons/MagicTrollDungeonLIB.lua");
dofile(get_locale_base_path().."/quest/Elendosfiles_Dungeons/PyramidDungeonLIB.lua");
dofile(get_locale_base_path().."/quest/Elendosfiles_Dungeons/ShadowZoneLIB.lua");
dofile(get_locale_base_path().."/quest/Elendosfiles_Dungeons/ScorpionRuinsLIB.lua");
dofile(get_locale_base_path().."/quest/Elendosfiles_Dungeons/AncientJungleLIB.lua");
dofile(get_locale_base_path().."/quest/Elendosfiles_Dungeons/AndunDungeon01/AndunDungeon01LIB.lua");
dofile(get_locale_base_path().."/quest/Elendosfiles_Dungeons/Easter2022/Easter2022LIB.lua");
dofile(get_locale_base_path().."/quest/Elendosfiles_Dungeons/Easter2020Dungeon/Easter2020DungeonLIB.lua");

ADMIN_LIST = {"[DEV]Elendos"}
...
dofile("locale/germany/quest/questing.lua")
dofile(get_locale_base_path().."/quest/itemshop_v2.lua")
...
--If you dont have this function
...
bio_data = {
	-- level, item, count, time, lucky, stone, afftype1, affvalue1, afftype2, affvalue2, afftype3, affvalue3 , afftype4, affvalue4, isChoose voher 900 f? 15 minuten
	{ 30, 30006, 10, 900 * 60, 60, 30220, "ATTBONUS_MONSTER", 5,0,0,0,0,0,0,0, 71035, 70022}, --Ork disi
	{ 40, 30047, 15, 900 * 60, 60, 30221, "MAX_HP", 800,0,0,0,0,0,0,0, 71035, 70022}, --Seytan hatirasi
	{ 50, 30015, 15, 900 * 60, 60, 30222, "ATTBONUS_HUMAN", 5,0,0,0,0,0,0,0, 71035, 70022}, --Lanet kitabi
	{ 60, 30050, 20, 900 * 60, 60, 30223, "ATT_BONUS", 50,0,0,0,0,0,0,0, 71035, 70022}, --Buz topu
	{ 70, 30165, 25, 900 * 60, 60, 30224, "ATTBONUS_MONSTER", 8,0,0,0,0,0,0,0, 71035, 70022}, --Zelkova
	{ 80, 30166, 30, 900 * 60, 60, 30225, "ATTACK_SPEED", 10,"ATT_BONUS",10,0,0,0,0,0, 71035, 70022}, --Tugyis
	{ 85, 30167, 40, 900 * 60, 60, 30226, "RESIST_WARRIOR", 10,"RESIST_ASSASSIN",10,"RESIST_SURA",10,"RESIST_SHAMAN",10,0, 71035, 70022}, --Kirmizi hayalet dal
	{ 90, 30168, 50, 900 * 60, 60, 30227, "ATT_BONUS_TO_WARRIOR", 10,"ATT_BONUS_TO_ASSASSIN",10,"ATT_BONUS_TO_SURA",10,"ATT_BONUS_TO_SHAMAN",10,0, 71035, 70022}, --Kirmizi hayalet dal
	{ 92, 30251, 10, 900 * 60, 60, 0, "MAX_HP", 1000,"DEF_BONUS",120,"ATT_BONUS",50,0,0,1, 71035, 70022}, --92 gorevi
	{ 94, 30252, 20, 900 * 60, 60, 30228, "MAX_HP", 1100,"DEF_BONUS",140,"ATT_BONUS",60,0,0,1, 71035, 70022}, --92 gorevi
}